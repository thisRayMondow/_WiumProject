<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
    {{-- <a class="navbar-brand brand-logo" href="/dashboard"><img src="/vendors/assets/images/logo.svg"
        alt="logo" /></a> --}}
    {{-- <a class="navbar-brand brand-logo" href="/dashboard"><img src="/vendors/assets/images/logo-mini.svg"
        alt="logo" /></a> --}}
  ...
  <div class="navbar-menu-wrapper d-flex align-items-stretch">
    <button class="navbar-toggler navbar-toggler align-self-center" type="button" data-toggle="minimize">
      <span class="mdi mdi-chevron-left-circle-outline text-primary"> {{ auth()->user()->departement->name }}</span>
    </button>
    ...
    <ul class="navbar-nav navbar-nav-right">
      ...
      <li class="nav-item nav-profile dropdown">
        <a class="nav-link dropdown-toggle" id="profileDropdown" href="/dashboard" data-bs-toggle="dropdown"
          aria-expanded="false">
        ...
        <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
          ...
          <form action="/logout" method="post">
            @csrf
            <button type="submit" class="dropdown-item"><i class="mdi mdi-logout me-2 text-primary"></i> Signout
            </button>
          </form>
